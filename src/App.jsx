...
const SEED_WORKOUTS_LUARA = [
  { name: "Dia 1 — Superior A", exercises: [
    ...
    { name: "Rosca Direta", category: "biceps", sets: 3, repsMin: 10, repsMax: 12, rir: "1", load: "6 kg", rest: "60 seg", refNote: "Cotovelos fixos ao lado do corpo", supersetGroup: "l-d1-5", supersetLabel: "Bi-set" },
  ...
  { name: "Dia 2 — Inferior A (coluna protegida)", exercises: [
    { name: "Leg Press 45°", category: "perna", sets: 4, repsMin: 8, repsMax: 12, rir: "1 a 2", load: "77 kg (mantém a carga atual)", rest: "90 a 120 seg", refNote: "Prioridade nº1 de perna — apoio total das costas, sem compressão axial na coluna" },
    { name: "Cadeira Extensora", category: "perna", sets: 3, repsMin: 10, repsMax: 12, rir: "1 a 2", load: "25,5 kg (mantém a carga atual)", rest: "90 seg", refNote: "Troca o Hack Squat, como combinado — apoio total das costas, sem compressão axial" },
    { name: "Leg Press Unilateral", category: "perna", sets: 3, repsMin: 8, repsMax: 10, rir: "2", load: "Comece por volta de 35 a 40 kg por perna e ajuste pelo RIR", rest: "90 seg", refNote: "Por perna. Substitui a Passada no Lugar — apoio total das costas, sem exigir equilíbrio em pé" },
    { name: "Elevação Pélvica (Hip Thrust/Articulada)", category: "gluteo", sets: 3, repsMin: 10, repsMax: 12, rir: "1 a 2", load: "Mantenha a carga que já usa na Elevação Pélvica Articulada e ajuste pelo RIR", rest: "90 seg", refNote: "Excelente para glúteo com baixíssimo estresse lombar — pode ser priorizado" },
    { name: "Cadeira Abdutora", category: "gluteo", sets: 3, repsMin: 12, repsMax: 15, rir: "1", load: "38,5 kg (mantém a carga atual)", rest: "60 seg", refNote: "Trabalha estabilidade de quadril, relevante para o padrão de dança" },
    { name: "Panturrilha na Leg Press", category: "perna", sets: 3, repsMin: 12, repsMax: 15, rir: "1", load: "~68 kg (referência: Gêmeos no Leg Press atual)", rest: "60 seg", refNote: "Evita a extensão forçada da lombar que a panturrilha em pé com barra pode gerar" },
  ]},
  { name: "Dia 3 — Core + Mobilidade + Cardio leve", exercises: [
    { name: "Curl-up Modificado (McGill)", category: "abdomen", sets: 3, repsMin: 8, repsMax: 10, rir: "", load: "Peso do corpo", rest: "Sem pausa", refNote: "Cada repetição inclui hold de 8 a 10s. Evite fazer como 1º exercício antes de treino pesado de perna" },
    { name: "Prancha Lateral (Side Plank)", category: "abdomen", sets: 3, repsMin: 20, repsMax: 30, rir: "", load: "Peso do corpo", rest: "Sem pausa", refNote: "Medido em segundos por lado, não repetições. Alinhamento reto da cabeça aos pés" },
    { name: "Bird Dog", category: "lombar", sets: 3, repsMin: 8, repsMax: 10, rir: "", load: "Peso do corpo", rest: "Sem pausa", refNote: "Por lado. Movimento lento; lombar neutra o tempo todo" },
    { name: "Pallof Press (Anti-rotação, cabo/elástico)", category: "abdomen", sets: 3, repsMin: 10, repsMax: 12, rir: "", load: "Novo — comece na resistência mais leve do cabo/elástico", rest: "60 seg", refNote: "Por lado. Resista à rotação do tronco — não gire" },
    { name: "Mobilidade de Quadril (90/90) + Torácica", category: "geral", sets: 1, repsMin: 8, repsMax: 10, rir: "", load: "—", rest: "—", refNote: "Duração em minutos, não repetições. Evite amplitude extrema de lombar" },
    { name: "Escada (StairMaster/step)", category: "cardio", sets: 1, repsMin: 20, repsMax: 25, rir: "", load: "—", rest: "—", refNote: "Duração em minutos. Ritmo moderado e constante" },
  ]},
  { name: "Dia 4 — Superior B", exercises: [
    { name: "Supino Inclinado (Halteres, 30°)", category: "peito", sets: 3, repsMin: 8, repsMax: 10, rir: "1 a 2", load: "Novo — comece com halteres de 8 a 10 kg cada mão", rest: "90 seg", refNote: "Ênfase em peito superior; banco dá suporte total às costas" },
    { name: "Remada Unilateral Apoiada (Halter, tronco apoiado no banco)", category: "costas", sets: 3, repsMin: 10, repsMax: 12, rir: "1 a 2", load: "Novo — comece com halter de 10 a 12 kg", rest: "90 seg", refNote: "O apoio do tronco no banco tira toda a carga da lombar" },
    { name: "Elevação Lateral (Máquina ou Halteres)", category: "ombro", sets: 3, repsMin: 12, repsMax: 15, rir: "1", load: "4 kg (mesma carga atual)", rest: "60 seg", refNote: "Controle a descida, sem usar embalo" },
    { name: "Barra Fixa Assistida", category: "costas", sets: 3, repsMin: 10, repsMax: 12, rir: "1", load: "Ajuste o nível de assistência para falhar por volta da 10ª a 12ª repetição", rest: "90 seg", refNote: "Ajuste a assistência para manter a faixa de reps" },
    { name: "Rosca Alternada (Halteres)", category: "biceps", sets: 3, repsMin: 10, repsMax: 12, rir: "1", load: "~6 kg (referência: Rosca Simultânea atual)", rest: "Sem pausa", refNote: "Super-série com Tríceps Corda", supersetGroup: "l-d4-5", supersetLabel: "Bi-set" },
    { name: "Tríceps Corda (Polia)", category: "triceps", sets: 3, repsMin: 12, repsMax: 15, rir: "1", load: "~12 a 15 kg (mesma referência do Dia 1)", rest: "60 seg", refNote: "Fecha a super-série", supersetGroup: "l-d4-5", supersetLabel: "Bi-set" },
    { name: "Face Pull", category: "ombro", sets: 2, repsMin: 15, repsMax: 15, rir: "1 a 2", load: "Novo — comece leve (~8 a 10 kg no cabo) e priorize a técnica", rest: "60 seg", refNote: "Saúde do ombro — relevante pelo histórico de dança/mobilidade" },
  ]},
  { name: "Dia 5 — Inferior B (posterior/glúteo)", exercises: [
    { name: "Mesa Flexora (Isquiotibiais)", category: "perna", sets: 3, repsMin: 10, repsMax: 12, rir: "1 a 2", load: "23 kg (mantém a carga atual)", rest: "90 seg", refNote: "Contração completa no topo, sem tranco" },
    { name: "Cadeira Flexora", category: "perna", sets: 3, repsMin: 10, repsMax: 12, rir: "1 a 2", load: "20,5 kg (mantém a carga atual)", rest: "90 seg", refNote: "Substitui o Stiff — sem exigência de dobradiça de quadril sob carga" },
    { name: "Cadeira Adutora", category: "gluteo", sets: 3, repsMin: 12, repsMax: 15, rir: "1", load: "34,5 kg (mantém a carga atual)", rest: "60 seg", refNote: "Estabilidade de quadril" },
    { name: "Glúteo Máquina", category: "gluteo", sets: 3, repsMin: 12, repsMax: 15, rir: "1", load: "23 kg (mantém a carga atual)", rest: "60 seg", refNote: "Substitui o Coice na Polia, que gerou dor" },
    { name: "Ponte de Glúteo Unilateral", category: "gluteo", sets: 3, repsMin: 10, repsMax: 12, rir: "1 a 2", load: "Peso do corpo (ou halter leve sobre o quadril como progressão)", rest: "60 seg", refNote: "Por perna. Boa opção de baixo impacto para glúteo" },
    { name: "Panturrilha Sentada", category: "perna", sets: 3, repsMin: 12, repsMax: 15, rir: "1", load: "Nova variação — comece perto de 40 a 45 kg e ajuste pelo RIR", rest: "45 seg", refNote: "Fecha o dia com baixo estresse articular" },
  ]},
  { name: "Dia 6 — Pump + Core (opcional)", exercises: [
    { name: "Elevação Pélvica (volume leve)", category: "gluteo", sets: 3, repsMin: 12, repsMax: 15, rir: "2", load: "~60 a 70% da carga do Dia 2", rest: "60 seg", refNote: "Volume extra de glúteo — não é dia de força" },
    { name: "Elevação Lateral (Halteres, leve)", category: "ombro", sets: 3, repsMin: 15, repsMax: 15, rir: "2", load: "~3 kg", rest: "45 seg", refNote: "Foco em bombear o ombro, sem buscar carga alta" },
    { name: "Cadeira Abdutora/Adutora (super-série)", category: "gluteo", sets: 3, repsMin: 15, repsMax: 15, rir: "1 a 2", load: "~25 kg / ~22 kg (mais leve que os dias principais)", rest: "45 seg", refNote: "Circuito leve para a região de maior interesse estético" },
    { name: "Curl-up Modificado + Bird Dog (circuito)", category: "abdomen", sets: 3, repsMin: 8, repsMax: 10, rir: "", load: "Peso do corpo", rest: "Sem pausa", refNote: "Repete o Big 3 de McGill — reforço, não substitui o Dia 3" },
    { name: "Escada (ritmo leve)", category: "cardio", sets: 1, repsMin: 15, repsMax: 20, rir: "", load: "—", rest: "—", refNote: "Duração em minutos. Recuperação ativa" },
  ]},
];
...
const SEED_WORKOUTS_GUILHERME = [
  ...
  { name: "Dia 2 — Força: Inferior", exercises: [
    { name: "Agachamento Livre ou Leg Press 45°", category: "perna", sets: 4, repsMin: 4, repsMax: 5, rir: "2", load: "", rest: "180 a 210 seg", refNote: "(Foco: Força) Priorize ROM completo antes de perseguir carga" },
    { name: "Levantamento Terra Romeno (Stiff)", category: "perna", sets: 3, repsMin: 5, repsMax: 6, rir: "2", load: "", rest: "150 seg", refNote: "(Foco: Força) Quadril para trás, joelho quase estendido" },
    { name: "Afundo Búlgaro (Halteres)", category: "perna", sets: 3, repsMin: 6, repsMax: 8, rir: "2", load: "", rest: "120 seg", refNote: "(Foco: Força/Unilateral) Por perna. Corrige assimetrias entre pernas" },
    { name: "Panturrilha em Pé", category: "perna", sets: 4, repsMin: 8, repsMax: 10, rir: "1", load: "", rest: "60 seg", refNote: "(Foco: Acessório) Pausa de 1 seg no alongamento" },
